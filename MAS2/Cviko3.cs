...
public class Cviko3
{
    ...
    // File paths
        ...
        var results = new Dictionary<string, List<(double precision, double recall, double f2)>>();
        foreach (var alg in algorithms.Keys)
            results[alg] = new List<(double, double, double)>();
        ...
        for (int foldIdx = 0; foldIdx < foldsCount; foldIdx++)
        {
            ...
            foreach (var alg in algorithms)
            {
                ...
                results[alg.Key].Add((precision, recall, f2));
            }
        }
        ...
        foreach (var alg in algorithms.Keys)
        {
            ...
            Console.WriteLine($"{alg}: Precision avg={avgP:F3} std={stdP:F3}, Recall avg={avgR:F3} std={stdR:F3}, F2 avg={avgF2:F3} std={stdF2:F3}");
        }
